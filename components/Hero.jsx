...
const Hero = () => {
  return (
    <div className="bg-gradient-to-r from-[#e7dcdc] to-[#4bcf9d] text-black pt-20 sm:flex justify-between items-center sm:px-20 sm:pb-20 pb-10">
      <div className="sm:w-[50%]">
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="mt-6">
            <Link
              href="/login"
              className="bg-color-2 font-thin py-2 px-6 rounded-md hover:bg-main"
            >
              Get Started
            </Link>
          </div>
